def get_w2v_single_config(arch="x86_64", w2v_model="cbow"):
    ...
    config = {
        ...
        # Output paths
        "optuna_dir": f"{BASE_PATH}/experiment/outputs/optuna/word2vec/{w2v_model}/{arch_tag}",
        "result_dir": f"{BASE_PATH}/experiment/outputs/results/word2vec/{w2v_model}/{arch_tag}",
        "log_dir":    f"{BASE_PATH}/experiment/outputs/logs/word2vec/{w2v_model}/{arch_tag}",
        "plot_dir":   f"{BASE_PATH}/experiment/outputs/plots/word2vec/{w2v_model}/{arch_tag}",
    }
